...
var getSpellcheckerType = function() {
  if (!defaultSpellcheck) {
    return -1;
  }

  defaultSpellcheck.getSpellcheckerType.apply(defaultSpellcheck, arguments);
};
...
module.exports = {
  ...
  SPELLCHECKER_HUNSPELL: 0,
  SPELLCHECKER_MACOS: 1,
  SPELLCHECKER_WINDOWS: 2,
};
